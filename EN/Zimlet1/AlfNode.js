 ...
 */
YAHOO.widget.AlfNode = function(oData, oParent, expanded, checked) {
...
YAHOO.extend(YAHOO.widget.AlfNode, YAHOO.widget.TextNode, {
    ...
    toString: function() {
        return "AlfNode (" + this.index + ") " + this.label;
    }
