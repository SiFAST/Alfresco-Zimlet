...
<import resource="/Espace racine/Dictionnaire de données/Extensions de Web Scripts/org/alfresco/fastpublish/configuration.js">
	...
	if ( matchStr == null ) {
		...
		for ( var i = 0 ; i < nodes.length ; i ++ ) {
			...
			if(nodes[i].isContainer) {
				...
				if ( startsWith(displayPath,"/Espace racine") )
					displayPath = displayPath.substring("/Espace racine".length);
